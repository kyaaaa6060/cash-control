    ...
    try:
        ...
        if res.status_code == 200:
            ...
            for i, asset in enumerate(universe):
                ...
                # LİKİDASYON (Liq) HESAPLAMA MANTIĞI
                liq_high = mark_px * 1.022  # Yukarı yönlü short tasfiye sınırı
                liq_low = mark_px * 0.978   # Aşağı yönlü long tasfiye sınırı
                ...
                processed_coins[name] = {
                    ...
                    "liquidations": {
                        ...
                        "liqLow": liq_low,
                        "ratio": "%52.4 / %47.6",
                        "risk": "Normal" if abs(funding) < 0.05 else "Yüksek"
                    }
                }
...
app = FastAPI(title="Cash Control Engine - Live Trade Tracking", version="13.5", lifespan=lifespan)
